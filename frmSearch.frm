...
Private Sub DoComp(strFile As String, strFPath As String, strSparePath As String)
    ...
    If strSuffix = "-t" Then
        strBatText = "java -cp " & ChrW$(34) & strTsUtilPath & ChrW$(34) & " TSUtil fmgr " & strSuffix & " -r -n" & ChrW$(34) & strFile & ChrW$(34) & " " & ChrW$(34) & strFPath & ChrW$(34) & " " & ChrW$(34) & strSparePath & ChrW$(34)
    ElseIf strSuffix <> "-t" Then
        strBatText = "java -cp " & ChrW$(34) & strTsUtilPath & ChrW$(34) & " TSUtil fmgr " & strSuffix & " -c -n" & ChrW$(34) & strFile & ChrW$(34) & " " & ChrW$(34) & strFPath & ChrW$(34) & " " & ChrW$(34) & strSparePath & ChrW$(34)
    End If
    Call ShellAndWait(strBatText, True, vbHide)
    DoEvents
End Sub
Public Function RemD2(ByRef rArray() As Variant, xArray() As Variant) As Variant
    Dim count3 As Long, high As Long
...
Errtrap:
    ...
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'RemD2' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
End Function
...
Private Sub cmdFixEng_Click()
    ...
    Dim strOrigPath As String, strEngpath As String, strStart As String, strEnd As String
    Dim strSFile    As String, strSName As String, strAnim As String, strNew As String, strDamp As String

    On Error GoTo Errtrap
    lblCount(0).Caption = Str(Val(lblCount(0).Caption) - 1)
    Select Case MsgBox("Do you also wish to check for missing Sounds in .eng/.wag files" & vbCrLf & "(This will slow things up somewhat)", vbYesNo Or vbExclamation Or vbDefaultButton1, App.Title)
...
Private Sub Command10_Click()
    'Remove animation from select .s files
    ...
    Select Case MsgBox("DO NOT REMOVE THE ANIMATIONS FROM ELECTRIC LOCOS WITH PANTOGRAPHS" & vbCrLf & "OTHERWISE THE PANTOGRAPHS WILL CEASE WORKING.", vbOKCancel Or vbCritical Or vbDefaultButton1, "Warning")
        ...
        If List1.IsSelected(i) = True Then
            ...
            If Right$(strFound, 2) = ".s" Then
                ...
                If Asc(Mid$(strTemp, 1, 1)) = 255 And Asc(Mid$(strTemp, 2, 1)) = 254 Then
                    ...
                    Ename = strTempFilesPath & "\" & strOrigFile
                ...
                Ename = strTempFilesPath & "\" & strOrigFile
                booWriteFile = True
                Call DoDeComp2(strOrigFile, strPath, strTempFilesPath)
                ...
                If booAnimRemoved = True Then
                    ...
                    Call DoComp(strOrigFile, strPath, strTempFilesPath)
...
Errtrap:
    If Err.Number = 75 Then
        Resume Next
    End If
    Select Case MsgBox("Error " & Err.Number & " = " & Err.Description & " occurred in file" & vbCrLf & strFound & vbCrLf & "", vbOKCancel Or vbExclamation Or vbDefaultButton1, App.Title)
...
Private Sub DoDeComp2(strFile As String, strFPath As String, strSparePath As String)
    ...
    ChDrive Left$(App.Path, 1)
    ''ChDir App.Path & "\TSUtil"
    strBatText = "java -cp " & ChrW$(34) & strTsUtilPath & ChrW$(34) & " TSUtil -l" & ChrW$(34) & App.Path & "\Reports\" & RouteName & "_decomp.log" & ChrW$(34) & "  fmgr " & strSuffix & " -e -n" & ChrW$(34) & strFile & ChrW$(34) & " " & ChrW$(34) & strFPath & ChrW$(34) & " " & ChrW$(34) & strSparePath & ChrW$(34)
...
Private Sub Command13_Click()
    'Auto convert selected engine to RailDriver
    ...
    Dim q             As Integer
    Dim myASCFile     As String, xx As Long
    Dim strBrakeForce As String, strStart As String, strEnd As String
    Dim booWrong      As Boolean, strWrong As String
...
AILoco:
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error #" & Err.Number & " " & Err.Description & " occurred when checking " & vbCrLf & strEngname & "Q = " & Str(q), vbExclamation, App.Title)
    Resume Next
...
Private Sub Command14_Click()
    ...
    Dim MSG     As String, Response As String, SparePath As String
    Dim i       As Integer
...
Private Sub Command15_Click()
    ...
    Dim MSG     As String, Response As String, SparePath As String, i As Integer
    Dim x       As Long, A$
...
Private Sub Command19_Click()
    ...
    Dim strESD As String, strStart As String, strEnd As String
...
Private Sub Command20_Click()
    'fix AI wheel radius for MSTS bin
    ...
    Dim Z         As Long, zz As Long, MSG As String, Response As String
    Dim SparePath As String, i As Integer, strTemp As String
...
Private Sub Command3_Click()
    'Convert selected files to DXT1
    Dim strFound          As String
    Dim i                 As Integer, x As Integer, strPath As String, strName As String
    Dim jj                As Integer, strAceView As String, strDir As String
    Dim strTGAF           As String, booFileName As Boolean, varBatText As String
    Dim Filpath1$, strOrigFile As String
    Dim strTGASave        As String
    Dim result            As Long
    Dim strOldAce         As String
    Dim strTempFiles2Path As String
    Dim strAceItPath      As String

    On Error GoTo Errtrap

    strTempFiles2Path = SpecialFolder(SpecialFolder_LocalAppData) & "\Route_Riter\TempFiles2"
    If Not DirExists(strTempFiles2Path) Then
        MkDir strTempFiles2Path
    End If
    Kill strTempFiles2Path & "\*.*"
    DoEvents
    Filpath1$ = strTempFiles2Path
    strAceItPath = GetSetting("Route_Riter6", "AceIt", "Path", "")
    If strAceItPath = vbNullString Then
        MsgBox "AceIt not found.", vbCritical
        Exit Sub
    End If
    MousePointer = 11
    Label6.Visible = True
    For i = 0 To List1.Rows - 1
        If List1.IsSelected(i) = True Then
            ...
            ChDir Filpath1$
            varBatText = ChrW$(34) & strAceItPath & "\AceIt.exe" & ChrW$(34) & " " & strTGAF & " " & Left$(strTGAF, Len(strTGAF) - 4) & ".ace -dxt /q"
...
Errtrap:
    If Err.Number = 53 Then
        Resume Next
    End If
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'frmSearch' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
End Sub
