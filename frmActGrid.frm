...
'Package activity
    ...
    FromAct = True
    strSpare = strTempFilesPath & "\Train Simulator"
...
Errtrap:
    If Err = 75 Then
        Resume Next
    End If
    Call MsgBox("An error " & Err & " " & Err.Description & " occurred in subroutine 'Package Activity' please advise" & vbCrLf & "that x=" & Str(x), vbExclamation, App.Title)
...
Errtrap:
    If Err = 53 Then
        ...
        Resume Next
    Else
        Call MsgBox("An error " & Err.Description & " occurred in subroutine 'Load ActGrid' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
        Resume Next
    End If
End Sub
...
Private Sub LooseActivities(ActPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error occurred in subroutine 'LooseActivities' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    'Resume Next
End Sub
...
Private Sub LooseConsistsGrid(ActPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error occurred in subroutine 'LooseConsistsGrid' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
...
Private Sub CheckForConsistCol(CFilepath As Variant, strAct As Variant, strSvc As Variant)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error occurred in subroutine 'CheckForConsistCol' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    'Resume Next
End Sub

Private Sub CheckForConsistGrid(CFilepath As String, _
                                nextrow As Integer, _
                                nextcol As Integer)
    Dim Fnumber      As Integer, strNew As String
    Dim x            As Integer, Engpath As String, Engname As String
...
Errtrap:
    If Err = 381 Then
        Resume Next
    Else
        Call MsgBox("An error #" & Err & " occurred in subroutine 'CheckForConsistGrid' while checking" & vbCrLf & CFilepath, vbExclamation, App.Title)
        Resume Next
    End If
End Sub
