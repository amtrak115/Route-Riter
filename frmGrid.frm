...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err & " occurred in LookForWag" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
End Sub
...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err & " occurred in LookForLoco" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
...
Private Sub SetLang()
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err & " occurred in SetLang" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
End Sub
...
Errtrap:
    ...
    Call MsgBox("An error " & Err & " occurred in subroutine 'frmGrid - Load' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
    GoTo TryAnother
End Sub
...
Private Sub LooseActivities(ActPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error " & Err & " occurred in subroutine 'LooseActivities' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err & " occurred in LooseConsistsGrid" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
...
Private Sub CheckForConsistCol(CFilepath As Variant, _
                               strAct As Variant, _
                               strSvc As Variant, _
                               flagEngRed As Boolean)
...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err & " occurred in CheckForConsistCol" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
...
Errtrap:
    ...
    Call MsgBox("An error #" & Err & " occurred in subroutine 'CheckForConsistGrid' while checking" & vbCrLf & CFilepath, vbExclamation, frmGrid)
