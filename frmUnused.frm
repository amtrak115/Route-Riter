...
Private Sub Form_Load()
    ...
    Dim Z       As Integer, q As Integer, booFound As Boolean, xx As Long
    Dim strTemp As String, ConsistPath As String
...
Private Sub CheckForConsistGrid(CFilepath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error #" & Err.Number & " occurred in subroutine 'CheckForConsistGrid' while checking" & vbCrLf & CFilepath, vbExclamation, App.Title)
...
Private Sub GridCon_MouseDown(Button As Integer, _
                              Shift As Integer, _
                              x As Single, _
                              Y As Single)
    If Button = 2 Then
...
Private Sub GridLoco_MouseDown(Button As Integer, _
                               Shift As Integer, _
                               x As Single, _
                               Y As Single)
    If Button = 1 Then
...
Private Sub GridPaths_MouseDown(Button As Integer, _
                                Shift As Integer, _
                                x As Single, _
                                Y As Single)
    If Button = 2 Then
...
Private Sub GridTfc_MouseDown(Button As Integer, _
                              Shift As Integer, _
                              x As Single, _
                              Y As Single)
...
Private Sub GridUnused_MouseDown(Button As Integer, _
                                 Shift As Integer, _
                                 x As Single, _
                                 Y As Single)
    If Button = 2 Then
...
Private Sub mnuDelPath_Click()
    ...
    Dim strTemp As String, x As Long, PathName As String
...
Private Sub mnuDelSvc_Click()
    ...
    Dim strTemp         As String, x As Long, RName As String
...
Private Sub mnuMovPath_Click()
    ...
    Dim strTemp      As String, x As Long, RName As String
    Dim PathName     As String, PathPath As String
