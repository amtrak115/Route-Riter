...
Private Sub CompareArrays()
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'CompareArrays' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
End Sub

Private Function DirDiverNew(NewPath As String, _
                             DirCount As Integer, _
                             Backup As String) As Integer
...
Private Function DirDiverOld(NewPath As String, _
                             DirCount As Integer, _
                             Backup As String) As Integer
    '  Recursively search directories from NewPath down...
    '  NewPath is searched on this recursion.
...
Private Sub Command3_Click()
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'frmUpdate - Command3' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
End Sub
