...
Dim strBrake As String, X1 As Integer
...
If Left(strCoupler, 7) = "Comment" Or Left(strCoupler, 8) = Chr(9) & "Comment" Then
qq = InStr(strCoupler, ")")
...
strShape = Replace(strShape, Chr$(34), "")
...
If Left$(strType, 1) = Chr$(34) Then
strType = Mid$(strType, 2)
End If
If Right$(strType, 1) = Chr$(34) Then
...
strBatText = Chr$(34) & App.path & "\sviewRR4.exe" & Chr$(34) & " " & Chr$(34) & _
    strPicView & Chr$(34)
...
strSFile = Left$(strSDFile, Len(strSDFile) - 1)
  ...
  If strNewSize <> vbNullString Then
    ...
    strBatText = Chr$(34) & App.path & "\sviewBB.exe" & Chr$(34) & " " & Chr$(34) & strSFile & ";" & strNewSize & Chr$(34)

Else
 strBatText = Chr$(34) & App.path & "\sviewBB.exe" & Chr$(34) & " " & Chr$(34) & strSFile & Chr$(34)
 End If
...
strStart = Left(MyString, x - 1)
x = InStr(x, MyString, Chr(13))
x = InStr(x + 3, MyString, Chr(13))
...
Frame2.Visible = False
'Stop
If Not FileExists(App.path & "\Support.tks") And strUser = vbNullString Then
