@Echo OFF
Rem Mischen zweier Strecken (OHNE Signaldefinitionen)
Rem Benutzung dieser Prozedur ab >>TSUtil V3.4.09C<<
Rem
if X%1==X goto .help
...
goto .ende
:.help
Echo Aufruf: merge-2 "<route1>" "<route2>"
...
Echo          Bitte TSUtil loeschen und Installation (V3.4.09C) wiederholen
goto .ende
:.rte
...
goto .ende
:.exec
java -Xmx512M -cp . TSUtil -$B "-l%3" merge -p -s "%TrSimPath%/Routes/%1" "%TrSimPath%/Routes/%2"
Set EL=%ERRORLEVEL%
