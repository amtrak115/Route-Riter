@Echo Off
Rem Umwandeln einer Strecke mit unterdrueckter Oberleitung (SectionIDX=150)
...
java -Xmx512M -cp . TSUtil -$B "-L%2" -j1:2 cvrt -inplace "%TrSimPath%/Routes/%1"
